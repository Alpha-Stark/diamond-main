                ...
                <Box cursor={"pointer"} textAlign={"left"} color={"#171616"} fontWeight={"400"}>
                    ...
                    <Box mt="50px" lineHeight={"40px"} fontWeight={"500"} boxSize="fit-content">
                        ...
                        <Text
                            ...
                            onMouseEnter={() => setHover("Bracelets")}
                        >
                            Bracelets
                        </Text>
                        <Text
                            ...
                            onMouseEnter={() => setHover("Earrings")}
                        >
                            Earrings
                        </Text>
                        <Text
                            ...
                            onMouseEnter={() => setHover("Necklaces")}
                        >
                            Necklaces & Pendants
                        </Text>
                        <Text
                        ...
                        <Text
                            ...
                            onMouseEnter={() => setHover("MensJewelry")}
                        >
                            Men's Jewelry
                        </Text>
