        ...
        <section className={styles.HomePage_sectionP1__kiHi} id={styles.HomePage_about__KBFWW}>
            <div className={styles.HomePage_firstDiv__2J3gv}>
                <div className={styles.HomePage_frstDiv1}>
                    <h1>About</h1>
                    <p>Shivstar Impex is More Than Just Gliding</p>
                    <p>Our Company is an exclusive supplier of Diamonds with the world's best quality. We take pride in offering our customers only the highest quality products.</p>
                    <p>We are constantly expanding our range to meet the needs of our customers and offer them the latest and most fashionable trends in Diamonds. We are confident that our collection of Diamonds will allow everyone to express their individual style and create a unique image</p>
            ...
            <div className={styles.HomePage_secondDiv__lALhm}>
